...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision col)
    {
        if (col.rigidbody)
        {
            ...
            GetComponent<Renderer>().material.SetFloat("_OffsetX" + waveNumber, distanceX / mesh.bounds.size.x * 25f);
            GetComponent<Renderer>().material.SetFloat("_OffsetZ" + waveNumber, distanceZ / mesh.bounds.size.z * 25f);
